...
```json
{
  ...
  "protocols": {
    "a2a": "https://detect-loaded-handbook-san.trycloudflare.com/.well-known/agent.json",
    "mcp": "https://detect-loaded-handbook-san.trycloudflare.com/.well-known/mcp.json",
    "openai_plugin": "https://detect-loaded-handbook-san.trycloudflare.com/.well-known/ai-plugin.json"
  },
