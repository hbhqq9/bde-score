...
async with streamablehttp_client("https://unnecessary-concert-gets-jose.trycloudflare.com/mcp") as (read, write, _):
...
| Endpoint | URL |
|----------|-----|
| MCP Server | `https://unnecessary-concert-gets-jose.trycloudflare.com/mcp` |
