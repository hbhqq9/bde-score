...
[![Market](https://img.shields.io/endpoint?url=https://detect-loaded-handbook-san.trycloudflare.com.trycloudflare.com/api/badge)](https://github.com/hbhqq9/bde-score)
[![AAPL](https://img.shields.io/endpoint?url=https://detect-loaded-handbook-san.trycloudflare.com.trycloudflare.com/api/badge?symbol=AAPL)]()
[![NVDA](https://img.shields.io/endpoint?url=https://detect-loaded-handbook-san.trycloudflare.com.trycloudflare.com/api/badge?symbol=NVDA)]()
[![00700](https://img.shields.io/endpoint?url=https://detect-loaded-handbook-san.trycloudflare.com.trycloudflare.com/api/badge?symbol=00700)]()
[![SH600519](https://img.shields.io/endpoint?url=https://detect-loaded-handbook-san.trycloudflare.com.trycloudflare.com/api/badge?symbol=SH600519)]()
...
curl "https://detect-loaded-handbook-san.trycloudflare.com.trycloudflare.com/compliance-check?url=https://your-mcp-endpoint.com"

# Get visual report (HTML)
# Open in browser: https://detect-loaded-handbook-san.trycloudflare.com.trycloudflare.com/compliance-check?url=https://your-mcp-endpoint.com
```
...
curl https://detect-loaded-handbook-san.trycloudflare.com.trycloudflare.com/api/snapshot?market=US

# Get all markets
curl https://detect-loaded-handbook-san.trycloudflare.com.trycloudflare.com/api/snapshot?market=ALL

# With Premium API Key (unlimited access)
curl -H "X-API-Key: bde_your_key_here" \
  https://detect-loaded-handbook-san.trycloudflare.com.trycloudflare.com/api/snapshot?market=ALL

# Historical data
curl https://detect-loaded-handbook-san.trycloudflare.com.trycloudflare.com/api/history?symbol=AAPL&days=30
```
...
curl https://detect-loaded-handbook-san.trycloudflare.com.trycloudflare.com/pay/info

# 2. Check your free quota
curl https://detect-loaded-handbook-san.trycloudflare.com.trycloudflare.com/pay/free

# 3. First 3 queries are FREE! No payment needed.
curl https://detect-loaded-handbook-san.trycloudflare.com.trycloudflare.com/pay/query?symbol=AAPL

# 4. After free quota, pay $0.01 with x402 (USDC on Base)
# The server returns HTTP 402 with payment requirements:
curl -i https://detect-loaded-handbook-san.trycloudflare.com.trycloudflare.com/pay/query?symbol=NVDA
...
response = await client.get(
    "https://detect-loaded-handbook-san.trycloudflare.com.trycloudflare.com/pay/query?symbol=AAPL"
)
```
...
claude mcp add bde-score --transport http --url https://freight-disabilities-agrees-rebates.trycloudflare.com/mcp
```
...
See [LICENSE](LICENSE) for the full text and dual-licensing notice.
