...
```json
{
  "mcpServers": {
    "bde-score": {
      "url": "https://category-pharmaceutical-competitive-footwear.trycloudflare.com/mcp",
      "headers": {
...
async with streamablehttp_client("https://category-pharmaceutical-competitive-footwear.trycloudflare.com/mcp") as (read, write, _):
...
| Endpoint | URL |
|----------|-----|
| MCP Server | `https://category-pharmaceutical-competitive-footwear.trycloudflare.com/mcp` |
