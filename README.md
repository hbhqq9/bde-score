...
[![Market](https://img.shields.io/endpoint?url=https://thinks-discussions-proof-dec.trycloudflare.com/api/badge)](https://github.com/hbhqq9/bde-score)
[![AAPL](https://img.shields.io/endpoint?url=https://thinks-discussions-proof-dec.trycloudflare.com/api/badge?symbol=AAPL)]()
[![NVDA](https://img.shields.io/endpoint?url=https://thinks-discussions-proof-dec.trycloudflare.com/api/badge?symbol=NVDA)]()
[![00700](https://img.shields.io/endpoint?url=https://thinks-discussions-proof-dec.trycloudflare.com/api/badge?symbol=00700)]()
[![SH600519](https://img.shields.io/endpoint?url=https://thinks-discussions-proof-dec.trycloudflare.com/api/badge?symbol=SH600519)]()
...
curl "https://thinks-discussions-proof-dec.trycloudflare.com/compliance-check?url=https://your-mcp-endpoint.com"

# Get visual report (HTML)
# Open in browser: https://thinks-discussions-proof-dec.trycloudflare.com/compliance-check?url=https://your-mcp-endpoint.com
```
  ...
  "mcpServers": {
    "bde-score": {
      "transport": {
        ...
        "url": "https://generators-computation-picked-emily.trycloudflare.com/mcp"
      }
    }
  }
}
...
curl https://thinks-discussions-proof-dec.trycloudflare.com/api/snapshot?market=US

# Get all markets
curl https://thinks-discussions-proof-dec.trycloudflare.com/api/snapshot?market=ALL

# With Premium API Key (unlimited access)
curl -H "X-API-Key: bde_your_key_here" \
  https://thinks-discussions-proof-dec.trycloudflare.com/api/snapshot?market=ALL

# Historical data
curl https://thinks-discussions-proof-dec.trycloudflare.com/api/history?symbol=AAPL&days=30
```
...
curl https://thinks-discussions-proof-dec.trycloudflare.com/pay/info

# 2. Check your free quota
curl https://thinks-discussions-proof-dec.trycloudflare.com/pay/free

# 3. First 3 queries are FREE! No payment needed.
curl https://thinks-discussions-proof-dec.trycloudflare.com/pay/query?symbol=AAPL

# 4. After free quota, pay $0.01 with x402 (USDC on Base)
# The server returns HTTP 402 with payment requirements:
curl -i https://thinks-discussions-proof-dec.trycloudflare.com/pay/query?symbol=NVDA
...
response = await client.get(
    "https://thinks-discussions-proof-dec.trycloudflare.com/pay/query?symbol=AAPL"
)
```
...
claude mcp add bde-score --transport http --url https://thinks-discussions-proof-dec.trycloudflare.com/mcp
```
